...
public class SubtractVisitor extends BinOpNumberVisitor<Number> {
	
	private static SubtractVisitor instance = new SubtractVisitor();
	
	public static SubtractVisitor getInstance() {
		return instance;
	}
