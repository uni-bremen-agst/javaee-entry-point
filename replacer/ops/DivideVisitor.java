...
public class DivideVisitor extends BinOpNumberVisitor<Number> {
	
	private static DivideVisitor instance = new DivideVisitor();
	
	public static DivideVisitor getInstance() {
		return instance;
	}
