...
public class MultiplyVisitor extends BinOpNumberVisitor<Number> {
	
	private static MultiplyVisitor instance = new MultiplyVisitor();
	
	public static MultiplyVisitor getInstance() {
		return instance;
	}
